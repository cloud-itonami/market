...
return byoubu.color.mix((function (){var iter__5480__auto__ = (function byoubu$facts$declared_content_color_$_iter__22553(s__22554){
...
var c__5478__auto__ = cljs.core.chunk_first(s__22554__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22556 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22555 = (0);
while(true){
if((i__22555 < size__5479__auto__)){
var vec__22558 = cljs.core._nth(c__5478__auto__,i__22555);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22558,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22558,(1),null);
cljs.core.chunk_append(b__22556,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(backdrop,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("byoubu","palette","byoubu/palette",851879321),k], null)),w], null));

var G__22607 = (i__22555 + (1));
i__22555 = G__22607;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22556),byoubu$facts$declared_content_color_$_iter__22553(cljs.core.chunk_rest(s__22554__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22556),null);
}
} else {
var vec__22561 = cljs.core.first(s__22554__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22561,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22561,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(backdrop,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("byoubu","palette","byoubu/palette",851879321),k], null)),w], null),byoubu$facts$declared_content_color_$_iter__22553(cljs.core.rest(s__22554__$2)));
}
} else {
return null;
}
...
var G__22565 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"declared","declared",92336021),byoubu.facts.declared_content_color(backdrop)], null);
var G__22565__$1 = (cljs.core.truth_(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"plate","plate",-1920178141),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22565,new cljs.core.Keyword(null,"plate","plate",-1920178141),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"plate","plate",-1920178141),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null))):G__22565);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22565__$1,new cljs.core.Keyword(null,"poster","poster",-1616913550),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"poster","poster",-1616913550),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null)));
} else {
return G__22565__$1;
}
});
...
return cljs.core.first(cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p__22567){
var vec__22568 = p__22567;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22568,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22568,(1),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22568,(2),null);
return (- r);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__22574){
var vec__22576 = p__22574;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22576,(0),null);
var hex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22576,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,hex,cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22566_SHARP_){
var or__5002__auto__ = byoubu.color.contrast_ratio(hex,p1__22566_SHARP_);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return 0.0;
...
var vec__22582 = byoubu.facts.best_ink(cljs.core.vals(tiers));
var ink_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22582,(0),null);
var ink = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22582,(1),null);
var ratio = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22582,(2),null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22588),byoubu$facts$derive_facts_$_iter__22585(cljs.core.chunk_rest(s__22586__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22588),null);
}
} else {
var vec__22600 = cljs.core.first(s__22586__$2);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22600,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22600,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [t,byoubu.color.contrast_ratio(ink,c)], null),byoubu$facts$derive_facts_$_iter__22585(cljs.core.rest(s__22586__$2)));
}
} else {
return null;
}
