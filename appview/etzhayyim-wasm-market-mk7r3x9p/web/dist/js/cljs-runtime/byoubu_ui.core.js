 ...
 *   broken one.
 */
byoubu_ui.core.media_element = (function byoubu_ui$core$media_element(p__22971){
var map__22973 = p__22971;
var map__22973__$1 = cljs.core.__destructure_map(map__22973);
var poster = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22973__$1,new cljs.core.Keyword(null,"poster","poster",-1616913550));
var loop_src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22973__$1,new cljs.core.Keyword(null,"loop-src","loop-src",1606654863));
var loop_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22973__$1,new cljs.core.Keyword(null,"loop-type","loop-type",136589048));
...
var len__5726__auto___23026 = arguments.length;
var i__5727__auto___23027 = (0);
while(true){
if((i__5727__auto___23027 < len__5726__auto___23026)){
args__5732__auto__.push((arguments[i__5727__auto___23027]));

var G__23028 = (i__5727__auto___23027 + (1));
i__5727__auto___23027 = G__23028;
continue;
} else {
}
break;
...
var backdrop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22987__$1,new cljs.core.Keyword(null,"backdrop","backdrop",-1291357381));
var assets_base = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22987__$1,new cljs.core.Keyword(null,"assets-base","assets-base",418340355));
var loop_src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22987__$1,new cljs.core.Keyword(null,"loop-src","loop-src",1606654863));
var poster = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22987__$1,new cljs.core.Keyword(null,"poster","poster",-1616913550));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22987__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22987__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var scrim_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22987__$1,new cljs.core.Keyword(null,"scrim?","scrim?",744210580));
var attrs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22987__$1,new cljs.core.Keyword(null,"attrs","attrs",-2090668713));
var loop_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22987__$1,new cljs.core.Keyword(null,"loop-type","loop-type",136589048));
var b = (function (){var G__22989 = ((cljs.core.map_QMARK_(backdrop))?new cljs.core.Keyword("byoubu","id","byoubu/id",459733156).cljs$core$IFn$_invoke$arity$1(backdrop):backdrop);
return (byoubu.core.fetch.cljs$core$IFn$_invoke$arity$1 ? byoubu.core.fetch.cljs$core$IFn$_invoke$arity$1(G__22989) : byoubu.core.fetch.call(null, G__22989));
})();
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__23005 = (byoubu_ui.core.class_name.cljs$core$IFn$_invoke$arity$1 ? byoubu_ui.core.class_name.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"stage","stage",1843544772)) : byoubu_ui.core.class_name.call(null, new cljs.core.Keyword(null,"stage","stage",1843544772)));
if(cljs.core.truth_(class$)){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23005)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(class$)].join('');
} else {
return G__23005;
}
...
/** @this {Function} */
(byoubu_ui.core.backdrop.cljs$lang$applyTo = (function (seq22978){
var G__22979 = cljs.core.first(seq22978);
var seq22978__$1 = cljs.core.next(seq22978);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22979,seq22978__$1);
}));
