...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag,(function (){var G__21775 = cljs.core.PersistentArrayMap.EMPTY;
var G__21775__$1 = ((cljs.core.seq(classes))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21775,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes)):G__21775);
if(cljs.core.truth_(id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21775__$1,new cljs.core.Keyword(null,"id","id",-1388402092),id);
} else {
return G__21775__$1;
}
})()], null);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("",cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__21780){
var vec__21781 = p__21780;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21781,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21781,(1),null);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__21784){
...
var vec__21788 = html.core.parse_tag(cljs.core.first(x));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21788,(0),null);
...
var vec__21804 = node;
var seq__21805 = cljs.core.seq(vec__21804);
var first__21806 = cljs.core.first(seq__21805);
var seq__21805__$1 = cljs.core.next(seq__21805);
var t = first__21806;
var body = seq__21805__$1;
var vec__21807 = html.core.parse_tag(t);
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21807,(0),null);
var base = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21807,(1),null);
var vec__21810 = ((cljs.core.map_QMARK_(cljs.core.first(body)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(body),cljs.core.rest(body)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentArrayMap.EMPTY,body], null));
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21810,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21810,(1),null);
...
var len__5726__auto___21888 = arguments.length;
var i__5727__auto___21890 = (0);
while(true){
if((i__5727__auto___21890 < len__5726__auto___21888)){
args__5732__auto__.push((arguments[i__5727__auto___21890]));

var G__21895 = (i__5727__auto___21890 + (1));
i__5727__auto___21890 = G__21895;
continue;
} else {
}
break;
...
/** @this {Function} */
(html.core.html.cljs$lang$applyTo = (function (seq21818){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq21818));
}));
...
while(true){
if((i__5727__auto___21903 < len__5726__auto___21901)){
args__5732__auto__.push((arguments[i__5727__auto___21903]));

var G__21904 = (i__5727__auto___21903 + (1));
i__5727__auto___21903 = G__21904;
continue;
} else {
}
break;
...
/** @this {Function} */
(html.core.html5.cljs$lang$applyTo = (function (seq21822){
var self__5712__auto__ = this;
