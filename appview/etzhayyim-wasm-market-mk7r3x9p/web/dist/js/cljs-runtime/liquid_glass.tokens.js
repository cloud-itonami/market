...
(liquid_glass.tokens.spring_linear_easing.cljs$core$IFn$_invoke$arity$1 = (function (p__21976){
var map__21977 = p__21976;
var map__21977__$1 = cljs.core.__destructure_map(map__21977);
var zeta = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21977__$1,new cljs.core.Keyword(null,"zeta","zeta",257464678),0.55);
var omega = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21977__$1,new cljs.core.Keyword(null,"omega","omega",277265652),13.0);
var samples = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21977__$1,new cljs.core.Keyword(null,"samples","samples",635504833),(16));
...
return ["linear(",clojure.string.join.cljs$core$IFn$_invoke$arity$2(",",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$iter__21990(s__21991){
return (new cljs.core.LazySeq(null,(function (){
var s__21991__$1 = s__21991;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__21991__$1);
if(temp__5825__auto__){
var s__21991__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__21991__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__21991__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__21993 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__21992 = (0);
while(true){
if((i__21992 < size__5479__auto__)){
var i = cljs.core._nth(c__5478__auto__,i__21992);
cljs.core.chunk_append(b__21993,fmt(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(samples - (1))))?1.0:pos((i / (samples - (1)))))));

var G__22059 = (i__21992 + (1));
i__21992 = G__22059;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21993),liquid_glass$tokens$iter__21990(cljs.core.chunk_rest(s__21991__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21993),null);
}
} else {
var i = cljs.core.first(s__21991__$2);
return cljs.core.cons(fmt(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(samples - (1))))?1.0:pos((i / (samples - (1)))))),liquid_glass$tokens$iter__21990(cljs.core.rest(s__21991__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$pair__GT_css_$_iter__21999(s__22000){
return (new cljs.core.LazySeq(null,(function (){
var s__22000__$1 = s__22000;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22000__$1);
if(temp__5825__auto__){
var s__22000__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22000__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22000__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22002 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22001 = (0);
while(true){
if((i__22001 < size__5479__auto__)){
var vec__22005 = cljs.core._nth(c__5478__auto__,i__22001);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22005,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22005,(1),null);
cljs.core.chunk_append(b__22002,["  ",liquid_glass.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__22098 = (i__22001 + (1));
i__22001 = G__22098;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22002),liquid_glass$tokens$pair__GT_css_$_iter__21999(cljs.core.chunk_rest(s__22000__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22002),null);
}
} else {
var vec__22008 = cljs.core.first(s__22000__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22008,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22008,(1),null);
return cljs.core.cons(["  ",liquid_glass.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),liquid_glass$tokens$pair__GT_css_$_iter__21999(cljs.core.rest(s__22000__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$tokens__GT_body_$_iter__22013(s__22014){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__22020 = cljs.core.first(xs__6385__auto__);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22020,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22020,(1),null);
var iterys__5476__auto__ = ((function (s__22014__$1,vec__22020,group,m,xs__6385__auto__,temp__5825__auto__){
return (function liquid_glass$tokens$tokens__GT_body_$_iter__22013_$_iter__22015(s__22016){
return (new cljs.core.LazySeq(null,((function (s__22014__$1,vec__22020,group,m,xs__6385__auto__,temp__5825__auto__){
return (function (){
var s__22016__$1 = s__22016;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__22016__$1);
if(temp__5825__auto____$1){
var s__22016__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__22016__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22016__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22018 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22017 = (0);
while(true){
if((i__22017 < size__5479__auto__)){
var vec__22024 = cljs.core._nth(c__5478__auto__,i__22017);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22024,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22024,(1),null);
if((!((v == null)))){
cljs.core.chunk_append(b__22018,liquid_glass.tokens.pair__GT_css(group,k,v));

var G__22124 = (i__22017 + (1));
i__22017 = G__22124;
continue;
} else {
var G__22125 = (i__22017 + (1));
i__22017 = G__22125;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22018),liquid_glass$tokens$tokens__GT_body_$_iter__22013_$_iter__22015(cljs.core.chunk_rest(s__22016__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22018),null);
}
} else {
var vec__22028 = cljs.core.first(s__22016__$2);
...
if((!((v == null)))){
return cljs.core.cons(liquid_glass.tokens.pair__GT_css(group,k,v),liquid_glass$tokens$tokens__GT_body_$_iter__22013_$_iter__22015(cljs.core.rest(s__22016__$2)));
} else {
var G__22132 = cljs.core.rest(s__22016__$2);
s__22016__$1 = G__22132;
continue;
}
}
} else {
...
});})(s__22014__$1,vec__22020,group,m,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__22014__$1,vec__22020,group,m,xs__6385__auto__,temp__5825__auto__))
;
var fs__5477__auto__ = cljs.core.seq(iterys__5476__auto__(m));
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,liquid_glass$tokens$tokens__GT_body_$_iter__22013(cljs.core.rest(s__22014__$1)));
} else {
var G__22136 = cljs.core.rest(s__22014__$1);
s__22014__$1 = G__22136;
continue;
}
} else {
return null;
