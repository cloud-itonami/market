...
var G__22479 = o;
reagent.impl.template.goog$module$goog$object.set(G__22479,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
return (function() { 
var G__22609__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__22609 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__22614__i = 0, G__22614__a = new Array(arguments.length -  0);
while (G__22614__i < G__22614__a.length) {G__22614__a[G__22614__i] = arguments[G__22614__i + 0]; ++G__22614__i;}
  args = new cljs.core.IndexedSeq(G__22614__a,0,null);
} 
return G__22609__delegate.call(this,args);};
G__22609.cljs$lang$maxFixedArity = 0;
G__22609.cljs$lang$applyTo = (function (arglist__22615){
var args = cljs.core.seq(arglist__22615);
return G__22609__delegate(args);
});
...
var G__22480 = o;
reagent.impl.template.goog$module$goog$object.set(G__22480,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
G__22633.cljs$lang$applyTo = (function (arglist__22637){
...
var G__22481 = props;
var G__22481__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22481,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22481);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22481__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22482 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22482,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22482;
}
})(),id_class);
...
var G__22483 = (cljs.core.count(argv) - first_child);
switch (G__22483) {
case (0):
...
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22484,(2),null);
...
var temp__5829__auto___22645 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22645 == null)){
} else {
var key_22646 = temp__5829__auto___22645;
(jsprops.key = key_22646);
}
...
var temp__5829__auto___22649 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22649 == null)){
} else {
var key_22650 = temp__5829__auto___22649;
(jsprops.key = key_22650);
}
...
var temp__5829__auto___22659 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22659 == null)){
} else {
var key_22661 = temp__5829__auto___22659;
(jsprops.key = key_22661);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22495_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22495_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22498 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22498,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22498,(1),null);
...
break;
default:
var G__22672 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22673 = compiler;
v = G__22672;
compiler = G__22673;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22536 = (function (opts,id,fn_to_element,parse_fn,meta22537){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22536.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22538,meta22537__$1){
var self__ = this;
var _22538__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22536(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22537__$1));
}));

(reagent.impl.template.t_reagent$impl$template22536.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22538){
var self__ = this;
var _22538__$1 = this;
return self__.meta22537;
}));

(reagent.impl.template.t_reagent$impl$template22536.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22536.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22536.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22536.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22536.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22536.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22537","meta22537",993658915,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22536.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22536.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22536");

(reagent.impl.template.t_reagent$impl$template22536.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template22536");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22536.
 */
reagent.impl.template.__GT_t_reagent$impl$template22536 = (function reagent$impl$template$__GT_t_reagent$impl$template22536(opts,id,fn_to_element,parse_fn,meta22537){
return (new reagent.impl.template.t_reagent$impl$template22536(opts,id,fn_to_element,parse_fn,meta22537));
});
...
return (new reagent.impl.template.t_reagent$impl$template22536(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
