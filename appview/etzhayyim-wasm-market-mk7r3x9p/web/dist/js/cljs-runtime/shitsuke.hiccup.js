...
var vec__21876 = (shitsuke.hiccup.parse_tag.cljs$core$IFn$_invoke$arity$1 ? shitsuke.hiccup.parse_tag.cljs$core$IFn$_invoke$arity$1(t) : shitsuke.hiccup.parse_tag.call(null, t));
...
var attrs__$2 = (function (){var G__21886 = attrs__$1;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(tag,"textarea")){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__21886,new cljs.core.Keyword(null,"value","value",305978217));
} else {
return G__21886;
}
})();
...
var content_21927 = shitsuke.hiccup.raw_text_content(children);
shitsuke.hiccup.assert_no_rawtext_breakout_BANG_(tag,content_21927);

cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(sb,content_21927);
} else {
